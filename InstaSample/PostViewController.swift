...
class PostViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UITextViewDelegate {
    ...
    let placeholderImage = UIImage(named: "photo_placeholder_color.png")
    ...
    @IBAction func sharePhoto() {
        ...
        file.saveInBackground({ (error) in
            if error != nil {
                ...
                let url = "https://mb.api.cloud.nifty.com/2013-09-01/applications/b2XQdphJZkri9Rm6/publicFiles/" + file.name
